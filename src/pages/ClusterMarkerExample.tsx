...
import { ClusterMarker, ClusterPin } from '@jetblack/map-cluster-marker'
...
const makePoint = (coordinate: Coordinate, nodes: Node<Feature<GeoPoint>>[]): Feature<GeoPoint> => ({
  type: 'Feature',
  geometry: {
    type: 'Point',
...
export default function ClusterMarkerExample() {
